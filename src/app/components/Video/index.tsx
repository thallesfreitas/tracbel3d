    ...
    return (
        <>
            <div className="w-full max-w-[90%] flex flex-col justify-center m-auto pt-20 max-md:max-w-[100%]" ref={elementRef}>
                ...
                <div className="video">
                    <iframe src="https://www.youtube.com/embed/hNrGZozxJW4?si=Sn0rjBDvSuu95mWg" title="YouTube video player" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share"></iframe>
